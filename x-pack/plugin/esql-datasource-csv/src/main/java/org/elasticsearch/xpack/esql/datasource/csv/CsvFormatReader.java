...
public class CsvFormatReader implements SegmentableFormatReader {
     ...
     * files are vanishingly rare in modern data pipelines. A future unification (see esql-planning#749)
     * will reconcile both layers under a single record splitter.
     *
